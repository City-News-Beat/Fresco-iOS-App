...
@interface FRSGalleryView() <UIScrollViewDelegate>
...
-(void)configurePageControl{
    ...
    [self.pageControl setOriginWithPoint:CGPointMake(self.scrollView.frame.size.width - 16 - self.pageControl.frame.size.width, self.scrollView.frame.size.height - 15 - self.pageControl.frame.size.height)];
...
-(void)configureTimeLine{
    self.clockIV = [[UIImageView alloc] init];
