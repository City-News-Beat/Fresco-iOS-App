...
-(void)setPostedDate {
    ...
    postedString = [NSString stringWithFormat:@"Posted %@ at %@", [FRSDateFormatter dateDifference:self.assignmentPostedDate], [formatter stringFromDate:self.assignmentPostedDate]];
