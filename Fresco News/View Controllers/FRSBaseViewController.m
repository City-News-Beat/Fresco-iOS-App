...
- (void)presentGenericError {
    FRSAlertView *alert = [[FRSAlertView alloc] initWithTitle:@"OOPS" message:@"Something’s wrong on our end. Sorry about that!" actionTitle:@"CANCEL" cancelTitle:nil cancelTitleColor:[UIColor frescoBlueColor] delegate:nil];
    [alert show];
}
