...
- (void)setUpDisabledFrog {
    ...
    UIImageView *disabledFrog = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"DUMB"]];
    ...
    NSLayoutConstraint *y = [NSLayoutConstraint constraintWithItem:disabledFrog attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterY multiplier:1.0 constant:0];
    
    [self.view addConstraint:y];
    
    NSLayoutConstraint *h = [NSLayoutConstraint constraintWithItem:disabledFrog attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeHeight multiplier:1.0 constant:0];
    
    [self.view addConstraint:h];
    
    NSLayoutConstraint *w = [NSLayoutConstraint constraintWithItem:disabledFrog attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeWidth multiplier:1.0 constant:0];
